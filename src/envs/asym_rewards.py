...
"""
    Important: these rewards can only be used with the environment UpkieStandUpAsymEnv.
"""
...
class StandingReward:
    ...
    def get(self, observation: np.ndarray) -> float:
        ...
        height = observation[18]
        pitch = observation[19]
